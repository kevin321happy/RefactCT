...
/**
 * Created by kevin321vip on 2017/10/10.
 * 自定义视频播放器
 */

public class CourseVedioPlay extends StandardGSYVideoPlayer {
  ...
  public void hideStartButton(){
     ...
     */
    public CourseVedioPlay(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }
    public CourseVedioPlay(Context context) {
        super(context);
    }

    public CourseVedioPlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.layout_course_vedio;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        CourseVedioPlay customGSYVideoPlayer = (CourseVedioPlay) gsyBaseVideoPlayer;
