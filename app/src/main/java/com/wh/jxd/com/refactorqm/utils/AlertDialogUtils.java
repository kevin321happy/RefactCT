...
public class AlertDialogUtils {
     ...
     * @param content
     */
    public static AlertDialog showTowBtnDialog(Activity context, String content, String leftText,
                                               String rightText,
...
//    }
    ...
    public static AlertDialog showSimpleMDDialog(Context context, String title, String message, View contentView,
    ...
    public static AlertDialog showSimpleDialog(Context context, String title, String message,
        ...
        return showSimpleMDDialog(context, title, message, null, positiveBtnText, negativeBtnText, positiveCallback, negativeCallback, cancelable);
    }
