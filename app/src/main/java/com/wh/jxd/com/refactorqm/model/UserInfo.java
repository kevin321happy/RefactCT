...
public class UserInfo  extends BaseModel implements Serializable {
  ...
  private String job_summary_id;//岗位的聚合ID

  public String getJob_summary_id() {
    return job_summary_id;
  }

  public void setJob_summary_id(String job_summary_id) {
    this.job_summary_id = job_summary_id;
  }
