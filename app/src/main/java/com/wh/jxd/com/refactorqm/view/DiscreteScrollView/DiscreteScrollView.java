package com.wh.jxd.com.refactorqm.view.DiscreteScrollView;
...
import com.wh.jxd.com.refactorqm.view.DiscreteScrollView.util.ScrollListenerAdapter;
...
//    public static final int NO_POSITION = DiscreteScrollLayoutManager.NO_POSITION;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
//            TypedArray ta=getContext().obtainStyledAttributes(attrs,R.style)
        ...
        layoutManager = new DiscreteScrollLayoutManager(getContext(), (DiscreteScrollLayoutManager.ScrollStateListener) new ScrollStateListener(), Orientation.values()[orientation]);
    ...
    public void addScrollListener(@NonNull ScrollListener<?> scrollListener) {
        addScrollStateChangeListener((ScrollStateChangeListener<?>) new ScrollListenerAdapter(scrollListener));
    }
    ...
    public void removeScrollListener(@NonNull ScrollListener<?> scrollListener) {
        removeScrollStateChangeListener((ScrollStateChangeListener<?>) new ScrollListenerAdapter<>(scrollListener));
    }
